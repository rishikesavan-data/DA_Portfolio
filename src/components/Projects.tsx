    ...
    <section id="projects" className="section-padding relative" ref={ref}>
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="relative flex items-center gap-8">
              ...
              >
                {currentProjects.map((project, i) => (
                  ...
                  >
                    ...
                    {/* In-Place Description Panel (Back Content) */}
                    <AnimatePresence>
                      {expandedIndex === i && (
                        <motion.div
                          initial={{ y: "100%" }}
          ...
          {/* Navigation Controls (Timeline Style) */}
          <div className="flex flex-col items-center gap-6 shrink-0 z-10 w-[40px] md:w-16 -translate-y-24">
            <button
              onClick={handlePrevPage}
              disabled={currentPage === 1}
              className={`p-2 md:p-3 rounded-full border border-border/50 bg-background/50 backdrop-blur-sm transition-all shadow-sm ${currentPage === 1
            ...
            <div className="flex flex-col items-center text-xs md:text-sm font-medium text-muted-foreground gap-1">
            ...
            <button
              ...
              className={`p-2 md:p-3 rounded-full border border-border/50 bg-background/50 backdrop-blur-sm transition-all shadow-sm ${currentPage === totalPages
                  ? "opacity-50 cursor-not-allowed text-muted-foreground"
                  : "hover:bg-primary/10 hover:text-primary hover:border-primary/30 active:scale-95 shadow-lg shadow-primary/5"
                }`}
            >
